// Kiểu dữ liệu nội dung tĩnh của trang chủ (Landing) — khớp payload từ
// GET /api/v1/home-page. Khối "Giải thưởng & Thành tích" dùng chung config
// trang About (xem @/types/about.types) nên không nằm ở đây.
