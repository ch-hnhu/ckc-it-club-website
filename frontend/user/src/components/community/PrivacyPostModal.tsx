...
const PrivacyPostModal: React.FC<Props> = ({ postId, currentVisibility, onClose, onSaved }) => {
	...
	const handleSave = async () => {
		...
		setSaving(true);
		try {
			await postService.updatePost(postId, { visibility: selected });
			onSaved(selected);
...
export default PrivacyPostModal;
