...
const BackToTop: React.FC = () => {
	...
	return (
		<button
			type="button"
			onClick={scrollToTop}
			className={`fixed bottom-24 right-6 z-50 flex items-center justify-center w-12 h-12 rounded-xl border-4 border-black bg-white shadow-[4px_4px_0px_#111] transition-all duration-300 hover:scale-110 active:scale-90 focus:outline-none ${
