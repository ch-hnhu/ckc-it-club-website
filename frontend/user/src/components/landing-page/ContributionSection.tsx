          ...
          >
            ...
            {submitted ? (
              <div className="p-8 flex flex-col items-center gap-4 text-center">
                ...
                <p className="text-gray-600">Tài nguyên của bạn đã được gửi đi và đang chờ duyệt.</p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="p-6 space-y-5">
                <div className="space-y-2">
                  <label className="text-sm font-bold text-black block" style={{ fontFamily: "var(--font-heading)" }}>
                    Tiêu đề tài nguyên *
                  </label>
                  <input
                    type="text"
