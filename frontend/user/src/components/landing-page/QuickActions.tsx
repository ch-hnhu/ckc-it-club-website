...
import { BookOpen, FileText, Trophy, Calendar, GraduationCap, Lightbulb, ArrowRight } from "lucide-react";
...
const QuickActions: React.FC = () => {
  ...
  return (
    <section ref={sectionRef} className="neo-section bg-white" id="resources">
