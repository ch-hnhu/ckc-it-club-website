        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="fade-in-up space-y-6">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              ...
              <strong className="text-black">Trường Cao đẳng Kỹ thuật Cao Thắng</strong>. Chúng tôi
              học, chia sẻ và cùng nhau phát triển — tin rằng mọi sinh viên đều có tiềm năng to lớn
              khi được hỗ trợ đúng cách.
            </p>
            <p className="text-gray-600 leading-relaxed">
              Từ năm 2018, chúng tôi đã kết nối hàng nghìn sinh viên với tài nguyên, mentor và cơ
              hội việc làm thực tế. Đây không chỉ là câu lạc bộ — đây là{" "}
              <span
                className="font-bold px-1 rounded"
                style={{ background: "var(--color-primary)", border: "1px solid #111" }}
              >
                ngôi nhà thứ hai
              </span>{" "}
              ...
              {[
                ...
                >
                  <div
                    ...
                    style={{ fontFamily: "var(--font-heading)", color: "var(--color-primary)", WebkitTextStroke: "0.5px #111" }}
                  >
                    {m.value}
                  </div>
