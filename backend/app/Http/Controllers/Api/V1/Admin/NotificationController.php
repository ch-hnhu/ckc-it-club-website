...
class NotificationController extends BaseApiController
{
	public function index(Request $request): JsonResponse
	{
		...
		$paginated = $user->notifications()
			->where('type', \App\Notifications\AdminActionNotification::class)
			->latest()
		...
		return $this->successResponse(true, [
			...
			'unread_count' => $user->unreadNotifications()->where('type', \App\Notifications\AdminActionNotification::class)->count(),
	...
	{
		$count = Auth::user()->unreadNotifications()->where('type', \App\Notifications\AdminActionNotification::class)->count();
